...
class XapClass
{
 public:
  ...
  bool partialMatchSource(char *source, char *target);  //Partial match of source (up to : section)
  bool matchSubAddress(char *lhs, char *rhs); // Match sub address
